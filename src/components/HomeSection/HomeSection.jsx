...
import heroImg2x from "/assets/image@2x.jpg";
      ...
      <div className={styles.contentWrapper}>
        <div className={styles.content}>
          <h1 className={styles.title}>
            The road to the <span className={styles.emphasis}>depths</span> of
            the human soul
          </h1>
          ...
          <button className={styles.getStarted} onClick={handleClick}>
            ...
            <div className={styles.statBadge}>
              <div className={styles.badgeBack}>
                <svg width={30} height={30} viewBox="0 0 32 32">
                  <path d="M8 13.333l-2.667 2.667 8 8 13.333-13.333-2.667-2.667-10.667 10.667-5.333-5.333z"></path>
                </svg>
              </div>
